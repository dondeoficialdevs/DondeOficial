...
export default function ActionCards() {
  ...
  return (
    <section className="relative bg-linear-to-br from-slate-50 via-orange-50 to-red-50 overflow-hidden py-8">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          ...
          >
            ...
            <div className="absolute inset-0 bg-linear-to-r from-orange-600/30 via-red-600/20 to-transparent"></div>
