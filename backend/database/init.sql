...
INSERT INTO businesses (
    name, description, address, phone, email, website, category_id, opening_hours
)
VALUES 
...
VALUES 
    ('Ana Torres', 'ana.torres@email.com', 'Consulta sobre servicios', 'Hola, me gustaría conocer más información sobre sus servicios.'),
    ('Carlos Rivera', 'carlos.rivera@email.com', 'Soporte técnico', 'Tengo problemas al registrar mi negocio en la plataforma. ¿Me pueden ayudar?'),
    ('Lucía Fernández', 'lucia.fernandez@email.com', 'Oportunidad de colaboración', 'Me interesa una colaboración con DondeOficial. Por favor, contáctenme.')
ON CONFLICT ON CONSTRAINT unique_lead_email_fullname DO NOTHING;

-- Insert sample newsletter subscribers
INSERT INTO newsletter_subscribers (email)
VALUES 
    ('sofia.mendez@email.com'),
